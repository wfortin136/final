...
is tightly integrated with the other resources, so for now I attempted to i
...
- Get UFC fight cards
- Get fights from each card
- Get fighters at each card
- Get round by round stats from each fighter in each fight

* Web scrape http://mmadecisions.com/
- Obtain judge round by round scores
- Map scorecards to fights
